...
ashade.init = function() {
	...
	let ashade_mobile_header = jQuery('<div class="ashade-mobile-header">'),
		mobile_menu_button = jQuery('<a href="#" class="ashade-mobile-menu-button"><i class="fa-solid fa-bars"></i></a>').appendTo(ashade_mobile_header),
 ...
 // Main faq Events
    jQuery('faq.a').on( 'mouseenter', function() {
        $ashade_body.addClass('ashade-menu-fade');
    });
    jQuery('faq.a').on( 'mouseleave', function() {
        $ashade_body.removeClass('ashade-menu-fade');
    });
	...
	jQuery('a').on('click', function(e) {
		...
		if ($this.attr('target') && '_blank' == $this.attr('target')) {
			...
			if (this_href == '#') {
				e.preventDefault();
			} else if ($this.hasClass('ashade-lightbox-link') || $this.hasClass('youtube-player')) {
				e.preventDefault();
